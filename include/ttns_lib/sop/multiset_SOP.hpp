#ifndef TTNS_OPERATOR_GEN_LIB_MULTISET_SOP_HPP
#define TTNS_OPERATOR_GEN_LIB_MULTISET_SOP_HPP
...
template <typename T> class multiset_SOP;
template <typename T> std::ostream& operator<<(std::ostream& os, const multiset_SOP<T>& op);
