...
find_library(CUTENSOR_LIBRARY NAMES libcutensor.so
    HINTS ${CUTENSOR_ROOT_DIR}/lib ${CUTENSOR_ROOT_DIR}/lib64
    $ENV{CUTENSOR_ROOT_DIR}/lib $ENV{CUTENSOR_ROOT_DIR}/lib64
    ${CUDA_TOOLKIT_ROOT_DIR}/lib ${CUDA_TOOLKIT_ROOT_DIR}/lib64
    $ENV{CUDA_TOOLKIT_ROOT_DIR}/lib $ENV{CUDA_TOOLKIT_ROOT_DIR}/lib64
    ${CUTENSOR_ROOT_DIR}lib64/${CUDAToolkit_VERSION_MAJOR}.${CUDAToolkit_VERSION_MINOR} ${CUTENSOR_ROOT_DIR}/lib64/${CUDAToolkit_VERSION_MAJOR}
    ...
    $ENV{LD_LIBRARY_PATH} ${CUTENSOR_LIBRARY_PATH}  
    lib lib/x64 cuda/lib cuda/lib64 lib/x64 /usr/local/cutensor /usr/lib /usr/lib/x86_64-linux-gnu
