...
find_path(CUTENSOR_INCLUDE_PATH cutensor.h
    HINTS ${CUTENSOR_ROOT_DIR} $ENV{CUTENSOR_ROOT_DIR} ${CUDA_TOOLKIT_ROOT_DIR} $ENV{CUDA_TOOLKIT_ROOT_DIR} $ENV{INCLUDE_PATH} ${CUTENSOR_INCLUDE} usr/local/cutensor usr usr/local /usr/include
    NO_DEFAULT_PATH
...
find_library(CUTENSOR_LIBRARY NAMES libcutensor.so
    HINTS ${CUTENSOR_ROOT_DIR} $ENV{CUTENSOR_ROOT_DIR} ${CUDA_TOOLKIT_ROOT_DIR} $ENV{CUDA_TOOLKIT_ROOT_DIR} $ENV{LD_LIBRARY_PATH} ${CUTENSOR_LIBRARY_PATH}  lib lib/x64  cuda/lib cuda/lib64 lib/x64 /usr/local/cutensor /usr/lib /usr/lib/x86_64-linux-gnu
