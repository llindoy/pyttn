...
def dntt_dynamics(N, chi1, Tind = 0, chi2 = None, nbose=10, nbosep = 40, output_skip=1):
    ...
    ofname = "dntt_"+str(N)+"_"+str(T)+"_"+str(chi1)+".h5"

    meV = 0.00003674930495
    kb = 3.1668114e-6
    ...
    gp = dVs[Tind]*(np.sqrt(np.tanh(beta*wp/2)))
    J = Js[Tind]

    print(J, wp, gp, w0, g, beta)
