...
def holstein_dynamics(ansatz, g, w0, gp, wp, J, N, chi1, beta = None, chi2 = None, tmax=200, dt=0.25, nbose=10, nbosep=32, ofname='holstein_1d.h5', output_skip=1, use_mode_combination=True, nbmax=2, nhilbmax=1024):
    ...
    if ansatz == "mps":
        ...
        if chi2 is None:
            topo = ntreeBuilder.mlmctdh_tree(sysinf.mode_dimensions(), chi1)
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('gp', type=float)
    ...
    parser.add_argument('--nbosep', type=int, default=32)
    parser.add_argument('--beta', type=float, default=None)

    parser.add_argument('--fname', type=str, default='holstein_peirels.h5')
