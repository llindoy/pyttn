...
def sbm_dynamics(Nb, alpha, wc, s, eps, delta, chi, nbose, dt, Ncut = 20, nstep = 1, Nw = 7.5, geom='star', ofname='sbm.h5', degree = 2, adaptive=True, spawning_threshold=2e-4, unoccupied_threshold=1e-4):
    ...
    bath = oqs.bosonic_bath(J, None, beta=beta)
    ...
    H, w = oqs.add_bath_hamiltonian(H, sOP("sz", 0), 2*g, w, geom=geom)
    print(H)
