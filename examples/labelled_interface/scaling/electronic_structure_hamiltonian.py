...
# NOTE: models.electronic_structure(t, U) already returns a raw system_info/Hamiltonian
# directly from the 1- and 2-electron integrals; there is no bath/OQS component here for
# the labelled interface (SystemInfo/OperatorBuilder/OQSModel) to simplify, so the system
# construction below is left as-is and predates/is orthogonal to that interface.
