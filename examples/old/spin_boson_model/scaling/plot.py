...
mv = 0
chim, mm = plot("chi_scaling_mps.h5", ax[0])
mv = max(mm, mv)
ax[0].loglog(chis, np.power(chis/chim, 3)*mm, 'k--', zorder=-1)
chim, mm = plot("chi_scaling_binary.h5", ax[0])
mv = max(mm, mv)
ax[0].loglog(chis, np.power(chis/chim, 4)*mm, 'k--', zorder=-1)
chim, mm = plot("chi_scaling_ternary.h5", ax[0])
mv = max(mm, mv)
ax[0].loglog(chis, np.power(chis/chim, 5)*mm, 'k--', zorder=-1)

chim, mm = plot("chi_scaling_mps_subspace.h5", ax[1], style='o-')
mv = max(mm, mv)
ax[1].loglog(chis, np.power(chis/chim, 3)*mm, 'k--', zorder=-1)
chim, mm = plot("chi_scaling_binary_subspace.h5", ax[1], style='o-')
mv = max(mm, mv)
ax[1].loglog(chis, np.power(chis/chim, 4)*mm, 'k--', zorder=-1)
chim, mm = plot("chi_scaling_ternary_subspace.h5", ax[1], style='o-')
mv = max(mm, mv)
