...
def run_sample(A, dt, nstep, sample):



def sbm_dynamics(Nb, alpha, wc, s, eps, delta, chi, nbose, dt, beta = None, nsamples=1, Ncut = 20, nstep = 1, Nw = 7.5, geom='star', ofname='sbm_metts.h5'):
