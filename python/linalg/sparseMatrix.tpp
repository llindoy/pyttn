...
#ifndef PYTHON_BINDING_LINALG_SPARSE_MATRIX_TPP
#define PYTHON_BINDING_LINALG_SPARSE_MATRIX_TPP
...
void init_csr_matrix(py::module &m, const std::string &label)
{
    ...
    using index_type = typename linalg::traits<ttype>::index_type;
...
#endif // PYTHON_BINDING_LINALG_SPARSE_MATRIX_TPP
