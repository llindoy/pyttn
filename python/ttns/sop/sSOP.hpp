...
void init_sSOP(py::module &m)
{
    ...
    py::class_<sOP>(m, "sOP")
        ...
        .def("assign", [](sOP &self, const sOP &o)
             { self = o; })
        .def("__copy__", [](const sOP &o)
             { return sOP(o); })
        .def("__deepcopy__", [](const sOP &o, py::dict)
             { return sOP(o); }, py::arg("memo"))
        ...
        .def("__add__", [](const sOP &a, const sPOP &b)
             { return a + b; })
        .def("__add__", [](const sOP &a, const sNBO<real_type> &b)
             { return a + b; })
        .def("__add__", [](const sOP &a, const sNBO<complex_type> &b)
             { return a + b; })
        .def("__add__", [](const sOP &a, const sSOP<real_type> &b)
             { return a + b; })
        .def("__add__", [](const sOP &a, const sSOP<complex_type> &b)
        ...
        .def("__sub__", [](const sOP &a, const sOP &b)
             { return a - b; })
        .def("__sub__", [](const sOP &a, const sPOP &b)
             { return a - b; })
        .def("__sub__", [](const sOP &a, const sNBO<real_type> &b)
             { return a - b; })
        .def("__sub__", [](const sOP &a, const sNBO<complex_type> &b)
             { return a - b; })
        .def("__sub__", [](const sOP &a, const sSOP<real_type> &b)
             { return a - b; })
        .def("__sub__", [](const sOP &a, const sSOP<complex_type> &b)
             { return a - b; }, R"mydelim(
        ...
        .def("__div__", [](const sOP &a, const real_type &b)
             { return a * (1.0 / b); })
        .def("__div__", [](const sOP &a, const numpy_complex_type &b)
             { return a * (1.0 / complex_type(b)); }, R"mydelim(
        ...
        .def("__mul__", [](const sOP &a, const coeff<real_type> &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const coeff<complex_type> &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const real_type &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const numpy_complex_type &b)
             { return a * complex_type(b); })
        .def("__mul__", [](const sOP &a, const sOP &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const sPOP &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const sNBO<real_type> &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const sNBO<complex_type> &b)
             { return a * b; }, R"mydelim(
        ...
        .def("__mul__", [](const sOP &a, const sSOP<real_type> &b)
             { return a * b; })
        .def("__mul__", [](const sOP &a, const sSOP<complex_type> &b)
             { return a * b; }, R"mydelim(
        ...
        .def("__rmul__", [](const sOP &a, const coeff<real_type> &b)
             { return a * b; })
        .def("__rmul__", [](const sOP &a, const coeff<complex_type> &b)
             { return a * b; })
        .def("__rmul__", [](const sOP &a, const real_type &b)
             { return a * b; })
        .def("__rmul__", [](const sOP &a, const numpy_complex_type &b)
             { return a * complex_type(b); }, R"mydelim(
    ...
    py::class_<sPOP>(m, "sPOP")
        ...
        .def("assign", [](sPOP &self, const sPOP &o)
             { self = o; })
        .def("__copy__", [](const sPOP &o)
             { return sPOP(o); })
        .def("__deepcopy__", [](const sPOP &o, py::dict)
             { return sPOP(o); }, py::arg("memo"))
        ...
        .def_property("ops", static_cast<const std::list<sOP> &(sPOP::*)() const>(&sPOP::ops), [](sPOP &o, const std::list<sOP> &i)
                      { o.ops() = i; }, "A list of the individual sOP objects forming the sPOP.")
        ...
        .def("__add__", [](const sPOP &a, const sOP &b)
             { return a + b; })
        .def("__add__", [](const sPOP &a, const sPOP &b)
             { return a + b; })
        .def("__add__", [](const sPOP &a, const sNBO<real_type> &b)
             { return a + b; })
        .def("__add__", [](const sPOP &a, const sNBO<complex_type> &b)
             { return a + b; })
        .def("__add__", [](const sPOP &a, const sSOP<real_type> &b)
             { return a + b; })
        .def("__add__", [](const sPOP &a, const sSOP<complex_type> &b)
             { return a + b; }, R"mydelim(
        ...
        .def("__sub__", [](const sPOP &a, const sOP &b)
             { return a - b; })
        .def("__sub__", [](const sPOP &a, const sPOP &b)
             { return a - b; })
        .def("__sub__", [](const sPOP &a, const sNBO<real_type> &b)
             { return a - b; })
        .def("__sub__", [](const sPOP &a, const sNBO<complex_type> &b)
             { return a - b; })
        .def("__sub__", [](const sPOP &a, const sSOP<real_type> &b)
             { return a - b; })
        .def("__sub__", [](const sPOP &a, const sSOP<complex_type> &b)
             { return a - b; }, R"mydelim(
        ...
        .def("__mul__", [](const sPOP &a, const coeff<real_type> &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const coeff<complex_type> &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const real_type &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const numpy_complex_type &b)
             { return a * complex_type(b); })
        .def("__mul__", [](const sPOP &a, const sOP &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const sPOP &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const sNBO<real_type> &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const sNBO<complex_type> &b)
             { return a * b; }, R"mydelim(
        ...
        .def("__mul__", [](const sPOP &a, const sSOP<real_type> &b)
             { return a * b; })
        .def("__mul__", [](const sPOP &a, const sSOP<complex_type> &b)
             { return a * b; }, R"mydelim(
        ...
        .def("__rmul__", [](const sPOP &a, const coeff<real_type> &b)
             { return a * b; })
        .def("__rmul__", [](const sPOP &a, const coeff<complex_type> &b)
             { return a * b; })
        .def("__rmul__", [](const sPOP &a, const real_type &b)
             { return a * b; })
        .def("__rmul__", [](const sPOP &a, const numpy_complex_type &b)
             { return a * complex_type(b); }, R"mydelim(
...

    {
        ...
        py::class_<coef>(m, "coeff_real")
            ...
            .def("assign", [](coef &self, const coef &o)
                 { self = o; })
            .def("assign", [](coef &self, const real_type &o)
                 { self = o; })
            .def("assign", [](coef &self, const func_type &o)
                 { self = o; })
            .def("__copy__", [](const coef &o)
                 { return coef(o); })
            .def("__deepcopy__", [](const coef &o, py::dict)
                 { return coef(o); }, py::arg("memo"))
        ...
        .def("load", 
         ...
         .def(py::pickle(
            ...
            .def("__isub__", [](coef &a, const real_type &b)
                 { return a -= b; })
            .def("__isub__", [](coef &a, const coef &b)
                 { return a -= b; })

            .def("__imul__", [](coef &a, const real_type &b)
                 { return a *= b; })
            .def("__imul__", [](coef &a, const coef &b)
                 { return a *= b; })

            .def("__idiv__", [](coef &a, const real_type &b)
                 { return a /= b; })

            .def("__div__", [](const coef &a, const real_type &b)
                 { return a / b; })
            .def("__div__", [](const coef &a, const numpy_complex_type b)
                 { return a / complex_type(b); })


            .def("__add__", [](coef &a, const coef &b)
                 { return a + b; })
            .def("__add__", [](coef &a, const coeff<complex_type> &b)
                 { return a + b; })
            .def("__add__", [](const coef &a, const real_type &b)
                 { return a + b; })
            .def("__add__", [](const coef &a, const numpy_complex_type b)
                 { return a + complex_type(b); })
            .def("__radd__", [](const coef &a, const real_type &b)
                 { return a + b; })
            .def("__radd__", [](const coef &a, const numpy_complex_type b)
                 { return a + complex_type(b); })


            .def("__sub__", [](coef &a, const coef &b)
                 { return a - b; })
            .def("__sub__", [](coef &a, const coeff<complex_type> &b)
                 { return a - b; })
            .def("__sub__", [](const coef &a, const real_type &b)
                 { return a - b; })
            .def("__sub__", [](const coef &a, const numpy_complex_type b)
                 { return a - complex_type(b); })
            .def("__rsub__", [](const coef &a, const real_type &b)
                 { return b-a; })
            .def("__rsub__", [](const coef &a, const numpy_complex_type b)
                 { return complex_type(b)-a; })

            .def("__mul__", [](const coef &a, const real_type &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const numpy_complex_type b)
                 { return a * complex_type(b); })
            .def("__mul__", [](coef &a, const coef &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const coeff<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const sOP &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const sPOP &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const sNBO<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const sNBO<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const sSOP<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](coef &a, const sSOP<complex_type> &b)
                 { return a * b; })

            .def("__rmul__", [](const coef &a, const real_type &b)
                 { return a * b; })
            .def("__rmul__", [](const coef &a, const numpy_complex_type &b)
                 { return a * complex_type(b); });
    }

    {
        ...
        py::class_<coef>(m, "coeff_complex")
            .def(py::init())
            .def(py::init<const real_type &>())
            .def(py::init([](const numpy_complex_type &o)
            ...
            .def("assign", [](coef &self, const coef &o)
                 { self = o; })
            .def("assign", [](coef &self, const coeff<real_type> &o)
                 { self = o; })
            .def("assign", [](coef &self, const real_type &o)
                 { self = o; })
            .def("assign", [](coef &self, const numpy_complex_type &o)
                 { self = complex_type(o); })
            .def("assign", [](coef &self, const func_type &o)
                 { self = o; })
            .def("assign", [](coef &self, const real_func_type &o)
                 { self = coeff<real_type>(o); })
            .def("__copy__", [](const coef &o)
                 { return coef(o); })
            .def("__deepcopy__", [](const coef &o, py::dict)
                 { return coef(o); }, py::arg("memo"))
        ...
        .def("load", 
         ...
         .def(py::pickle(
            ...
            .def("__iadd__", [](coef &a, const numpy_complex_type &b)
                 { return a += complex_type(b); })
            .def("__isub__", [](coef &a, const numpy_complex_type &b)
                 { return a -= complex_type(b); })
            .def("__imul__", [](coef &a, const numpy_complex_type &b)
                 { return a *= complex_type(b); })
            .def("__idiv__", [](coef &a, const numpy_complex_type &b)
                 { return a /= complex_type(b); })
            ...
            .def("__iadd__", [](coef &a, const coeff<real_type> &b)
                 { return a += b; })
            .def("__isub__", [](coef &a, const coeff<real_type> &b)
                 { return a -= b; })
            .def("__imul__", [](coef &a, const coeff<real_type> &b)
                 { return a *= b; })
            ...
            .def("__add__", [](const coef &a, const coef &b)
                 { return a + b; })
            .def("__sub__", [](const coef &a, const coef &b)
                 { return a - b; })
            .def("__mul__", [](const coef &a, const coef &b)
                 { return a * b; })
            .def("__add__", [](const coef &a, const coeff<real_type> &b)
                 { return a + b; })
            .def("__sub__", [](const coef &a, const coeff<real_type> &b)
                 { return a - b; })
            .def("__mul__", [](const coef &a, const coeff<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const sOP &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const sPOP &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const sNBO<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const sNBO<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const sSOP<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const coef &a, const sSOP<complex_type> &b)
                 { return a * b; })
...

    {
        ...
        py::class_<NBO>(m, "sNBO_real")
            ...
            .def("assign", [](NBO &self, const NBO &o)
                 { self = o; })
            .def("__copy__", [](const NBO &o)
                 { return NBO(o); })
            ...
            .def("__iter__", [](NBO &s)
                 { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>())
            .def_property("coeff", static_cast<const coeff<real_type> &(NBO::*)() const>(&NBO::coeff), [](NBO &o, const coeff<real_type> &i)
                          { o.coeff() = i; })
        ...
        .def("load", 
         ...
         .def(py::pickle(
            ...
            .def("__imul__", [](NBO &a, const sPOP &b)
                 { return a *= b; })
            .def("__imul__", [](NBO &a, const NBO &b)
                 { return a *= b; })
            .def("__imul__", [](NBO &a, const real_type &b)
                 { return a *= b; })

            .def("__add__", [](const NBO &a, const sOP &b)
                 { return a + b; })
            .def("__add__", [](const NBO &a, const sPOP &b)
                 { return a + b; })
            .def("__add__", [](const NBO &a, const sNBO<real_type> &b)
                 { return a + b; })
            .def("__add__", [](const NBO &a, const sNBO<complex_type> &b)
                 { return a + b; })
            .def("__add__", [](const NBO &a, const sSOP<real_type> &b)
                 { return a + b; })
            .def("__add__", [](const NBO &a, const sSOP<complex_type> &b)
                 { return a + b; })

            .def("__sub__", [](const NBO &a, const sOP &b)
                 { return a - b; })
            .def("__sub__", [](const NBO &a, const sPOP &b)
                 { return a - b; })
            .def("__sub__", [](const NBO &a, const sNBO<real_type> &b)
                 { return a - b; })
            .def("__sub__", [](const NBO &a, const sNBO<complex_type> &b)
                 { return a - b; })
            .def("__sub__", [](const NBO &a, const sSOP<real_type> &b)
                 { return a - b; })
            .def("__sub__", [](const NBO &a, const sSOP<complex_type> &b)
                 { return a - b; })

            .def("__div__", [](const NBO &a, const real_type &b)
                 { return a * (1.0 / b); })
            .def("__div__", [](const NBO &a, const numpy_complex_type &b)
                 { return a * (1.0 / complex_type(b)); })

            .def("__mul__", [](const NBO &a, const coeff<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const coeff<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const real_type &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const numpy_complex_type &b)
                 { return a * complex_type(b); })
            .def("__mul__", [](const NBO &a, const sOP &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const sPOP &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const sNBO<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const sNBO<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const sSOP<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const NBO &a, const sSOP<complex_type> &b)
                 { return a * b; })

            .def("__rmul__", [](const NBO &a, const coeff<real_type> &b)
                 { return a * b; })
            .def("__rmul__", [](const NBO &a, const coeff<complex_type> &b)
                 { return a * b; })
            .def("__rmul__", [](const NBO &a, const real_type &b)
                 { return a * b; })
            .def("__rmul__", [](const NBO &a, const numpy_complex_type &b)
                 { return a * complex_type(b); });
    }
    {
        ...
        py::class_<NBO>(m, "sNBO_complex")
            ...
            .def(py::init<const sOP &>())
            .def(py::init<const sPOP &>())
            .def(py::init([](const numpy_complex_type &coeff, const sPOP &o)
                          { return NBO(complex_type(coeff), o); }))
            .def(py::init([](const numpy_complex_type &coeff, const sOP &o)
                          { return NBO(complex_type(coeff), o); }))
            ...
            .def("assign", [](NBO &self, const NBO &o)
                 { self = o; })
            .def("assign", [](NBO &self, const sNBO<real_type> &o)
                 { self = o; })
            .def("__copy__", [](const NBO &o)
                 { return NBO(o); })
            .def("__deepcopy__", [](const NBO &o, py::dict)
        ...
        .def("load", 
         ...
         .def(py::pickle(
            ...
            .def("__imul__", [](NBO &a, const NBO &b)
                 { return a *= b; })
            .def("__imul__", [](NBO &a, const numpy_complex_type &b)
                 { return a *= complex_type(b); })
        ...
        .def("load", 
         ...
         .def(py::pickle(
            ...
            .def("__iadd__", [](_SOP &a, const sNBO<real_type> &b)
                 { return a += b; })
            .def("__iadd__", [](_SOP &a, const _SOP &b)
                 { return a += b; })
            ...
            .def("__isub__", [](_SOP &a, const sNBO<real_type> &b)
                 { return a -= b; })
            .def("__isub__", [](_SOP &a, const _SOP &b)
                 { return a -= b; })
            ...
            .def("__imul__", [](_SOP &a, const real_type &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const sOP &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const sPOP &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const sNBO<real_type> &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const _SOP &b)
                 { return a *= b; })

            .def("__add__", [](const _SOP &a, const sOP &b)
                 { return a + b; })
            .def("__add__", [](const _SOP &a, const sPOP &b)
                 { return a + b; })
            .def("__add__", [](const _SOP &a, const sNBO<real_type> &b)
                 { return a + b; })
            .def("__add__", [](const _SOP &a, const sNBO<complex_type> &b)
                 { return a + b; })
            .def("__add__", [](const _SOP &a, const sSOP<real_type> &b)
                 { return a + b; })
            .def("__add__", [](const _SOP &a, const sSOP<complex_type> &b)
                 { return a + b; })

            .def("__sub__", [](const _SOP &a, const sOP &b)
                 { return a - b; })
            .def("__sub__", [](const _SOP &a, const sPOP &b)
                 { return a - b; })
            .def("__sub__", [](const _SOP &a, const sNBO<real_type> &b)
                 { return a - b; })
            .def("__sub__", [](const _SOP &a, const sNBO<complex_type> &b)
                 { return a - b; })
            .def("__sub__", [](const _SOP &a, const sSOP<real_type> &b)
                 { return a - b; })
            .def("__sub__", [](const _SOP &a, const sSOP<complex_type> &b)
                 { return a - b; })

            .def("__div__", [](const _SOP &a, const real_type &b)
                 { return a * (1.0 / b); })
            .def("__div__", [](const _SOP &a, const numpy_complex_type &b)
                 { return a * (1.0 / complex_type(b)); })

            .def("__mul__", [](const _SOP &a, const coeff<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const coeff<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const real_type &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const numpy_complex_type &b)
                 { return a * complex_type(b); })
            .def("__mul__", [](const _SOP &a, const sOP &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const sPOP &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const sNBO<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const sNBO<complex_type> &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const sSOP<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const sSOP<complex_type> &b)
                 { return a * b; })

            .def("__rmul__", [](const _SOP &a, const coeff<real_type> &b)
                 { return a * b; })
            .def("__rmul__", [](const _SOP &a, const coeff<complex_type> &b)
                 { return a * b; })
            .def("__rmul__", [](const _SOP &a, const real_type &b)
                 { return b * a; })
            .def("__rmul__", [](const _SOP &a, const numpy_complex_type &b)
                 { return complex_type(b) * a; });
    }
    {
        ...
        py::class_<_SOP>(m, "sSOP_complex")
            ...
            .def(py::init<const _SOP &>())
            .def("assign", [](_SOP &self, const sSOP<real_type> &o)
                 { self = o; })
            .def("assign", [](_SOP &self, const _SOP &o)
                 { self = o; })
            .def("__copy__", [](const _SOP &o)
        ...
        .def("load", 
         ...
         .def(py::pickle(
            ...
            .def("__iadd__", [](_SOP &a, const sNBO<real_type> &b)
                 { return a += b; })
            .def("__iadd__", [](_SOP &a, const sNBO<complex_type> &b)
                 { return a += b; })
            ...
            .def("__isub__", [](_SOP &a, const sNBO<real_type> &b)
                 { return a += b; })
            .def("__isub__", [](_SOP &a, const sNBO<complex_type> &b)
                 { return a += b; })
            ...
            .def("__idiv__", [](_SOP &a, const real_type &b)
                 { return a *= 1.0/b; })
            .def("__idiv__", [](_SOP &a, const numpy_complex_type &b)
                 { return a *= 1.0/complex_type(b); })

            .def("__imul__", [](_SOP &a, const real_type &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const numpy_complex_type &b)
                 { return a *= complex_type(b); })
            .def("__imul__", [](_SOP &a, const sOP &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const sPOP &b)
            ...
            .def("__imul__", [](_SOP &a, const sNBO<real_type> &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const sNBO<complex_type> &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const sSOP<real_type> &b)
                 { return a *= b; })
            .def("__imul__", [](_SOP &a, const _SOP &b)
                 { return a *= b; })
            ...
            .def("__add__", [](const _SOP &a, const sSOP<real_type> &b)
                 { return a + b; })
            .def("__add__", [](const _SOP &a, const _SOP &b)
                 { return a + b; })
            ...
            .def("__sub__", [](const _SOP &a, const sSOP<real_type> &b)
                 { return a - b; })
            .def("__sub__", [](const _SOP &a, const _SOP &b)
                 { return a - b; })
            ...
            .def("__mul__", [](const _SOP &a, const sSOP<real_type> &b)
                 { return a * b; })
            .def("__mul__", [](const _SOP &a, const _SOP &b)
                 { return a * b; })
