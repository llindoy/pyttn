...
#ifndef PYTHON_BINDING_TTNS_SOP_OPERATOR_TPP
#define PYTHON_BINDING_TTNS_SOP_OPERATOR_TPP
...
void init_sop_operator(py::module &m, const std::string &label)
{
    ...
    py::class_<_sop>(m, (std::string("sop_operator_") + label).c_str())
        ...
        .def("bond_dimensions", &_sop::bond_dimensions)
        .def("bond_dimensions", [](const _sop &o)
...
void initialise_sop_operator_types(py::module &m)
{
