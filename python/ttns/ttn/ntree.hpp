...
void init_ntree(py::module &m)
{
    ...
    py::class_<ntree<T>>(m, "ntree")
        ...
        .def("clear", &ntree<T>::clear, "Deallocate all internal storage of the ntree object.  Setting it so that it has no nodes.")
        ...
        .def(
                "__str__", 
                [](const ntree<T>& o){std::stringstream oss;   oss << o; return oss.str();},R"mydelim(
        ...
        .def(
                "as_json", 
                [](const ntree<T>& o){std::stringstream oss;   o.as_json(oss); return oss.str();},R"mydelim(
...
void init_ntree_builder(py::module &m)
{
    ...
    py::class_<ntree_builder<T>>(m, "ntreeBuilder")
        ...
        .def_static("sanitise", &ntree_builder<T>::sanitise_tree, py::arg(), py::arg("remove_bond_matrices")=true,R"mydelim(
        ...
        .def_static("insert_basis_nodes", &ntree_builder<T>::insert_basis_nodes,R"mydelim(
        ...
        .def_static("sanitise_bond_dimensions", &ntree_builder<T>::sanitise_bond_dimensions,R"mydelim(
        ...
        .def_static("collapse_bond_matrices", &ntree_builder<T>::collapse_bond_matrices,R"mydelim(
        ...
        .def_static(
                        "mps_tree", 
                        static_cast<ntree<T>(*)(const std::vector<T>&, size_t&&, size_t&&)>(ntree_builder<T>::mps_tree),
                        R"mydelim(
        ...
        .def_static(
                        "mps_tree", 
                        static_cast<ntree<T>(*)(const std::vector<T>&, size_t&&, const std::vector<size_t>&)>(ntree_builder<T>::mps_tree),
                        R"mydelim(
                        Construct a new mps ntree for representing a tensor with dimensions specified in a list using an integer to specify the internal bond dimension. 
        ...
        .def_static(
                        "mps_tree", 
                        static_cast<ntree<T>(*)(const std::vector<T>&, const std::function<size_t(size_t)>&, const std::vector<size_t>&)>(ntree_builder<T>::mps_tree),
                        R"mydelim(
                        Construct a new mps ntree for representing a tensor with dimensions specified in a list using a function that depends on the distance from the root to specify the internal bond dimensions. 
                        Here the tree also automatically includes local optimised bases with the number of states being set by an array. 
        ...
        .def_static(
                        "mps_subtree", 
                        static_cast<void(*)(ntree_node<ntree<T>>&, const std::vector<T>&, size_t&&, const std::vector<size_t>&)>(ntree_builder<T>::mps_subtree),
                        R"mydelim(
                        Append a new mps to a node in an ntree for representing a tensor with dimensions specified in a list using an integer to specify the internal bond dimension. 
                        Here the tree also automatically includes local optimised bases with the number of states being set by an array. 
        ...
        .def_static(
                        "mps_subtree", 
                        static_cast<void(*)(ntree_node<ntree<T>>&, const std::vector<T>&, const std::function<size_t(size_t)>&, const std::vector<size_t>&)>(ntree_builder<T>::mps_subtree),
                        R"mydelim(
                        Append a new mps to a node in an ntree for representing a tensor with dimensions specified in a list using a function that depends on the distance from the root to specify the internal bond dimensions. 
                        Here the tree also automatically includes local optimised bases with the number of states being set by an array. 
