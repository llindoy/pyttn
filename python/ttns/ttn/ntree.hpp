...
void init_ntree(py::module &m)
{
    ...
    py::class_<ntree<T>>(m, "ntree")
        ...
        .def("__copy__", [](const ntree<T> &o)
             { return ntree<T>(o); })
        .def(
            "__deepcopy__",
            [](const ntree<T> &o, py::dict)
            { return ntree<T>(o); },
            py::arg("memo"))
        ...
        .def("save", [](const ntree<T> &a, const std::string &ofname, bool as_binary)
             { serialisation_utilities::save_obj(a, ofname, as_binary); }, py::arg(), py::arg("as_binary") = true)
        .def("load", [](ntree<T> &a, const std::string &ifname, bool as_binary)
             { serialisation_utilities::load_obj(a, ifname, as_binary); }, py::arg(), py::arg("as_binary") = true)
        .def(py::pickle([](const ntree<T> &a){ return serialisation_utilities::__getstate__(a); }, 
                        [](py::tuple t){ return serialisation_utilities::__setstate__<ntree<T>>(t); }))
#endif
