...
#ifndef PYTHON_BINDING_TTN_TPP
#define PYTHON_BINDING_TTN_TPP
...
void init_ttn(py::module &m, const std::string &label)
{
     ...
     py::class_<_ttn>(m, (std::string("ttn_") + label).c_str())
         ...
         .def("__setitem__", [](_ttn &i, size_t ind, const _ttn_node_data &o)
               {
                    //first over write the orthogonality centre. 
                    i[ind]() = o; 
                    i.reset_orthogonality_centre();
               }, "For details see :meth:`pyttn.ttn_dtype.__setitem__`")
         ...
         .def("at", [](_ttn &i, const std::vector<size_t> &ind) -> _ttn_node_data &
...
void initialise_ttn_types(py::module &m)
{
