...
#ifndef PYTHON_BINDING_MS_TTN_TPP
#define PYTHON_BINDING_MS_TTN_TPP
...
void init_msttn(py::module &m, const std::string &label)
{
    ...
    py::class_<_msttn>(m, (std::string("ms_ttn_") + label).c_str())
        ...
        .def(py::init<size_t, const std::string &, bool, bool>(), py::arg(), py::arg(), py::arg("collapse_bond_matrices") = true, py::arg("purification") = false)
        .def(py::init<size_t, const std::string &, const std::string, bool, bool>(), py::arg(), py::arg(), py::arg(), py::arg("collapse_bond_matrices") = true, py::arg("purification") = false)
        ...
        .def("__copy__", [](const _msttn &o)
             { return _msttn(o); })
        .def("__deepcopy__", [](const _msttn &o, py::dict)
             { return _msttn(o); }, py::arg("memo"))
        ...
        .def("bonds", [](const _msttn &o)
             {std::vector<std::pair<int, int>> edges; o.get_edges(edges); return edges; })

        .def("bond_dimensions", &_msttn::bond_dimensions)
        .def("bond_dimensions", [](const _msttn &o)
             {typename _msttn::hrank_info res;  o.bond_dimensions(res);   return res; })

        .def("bond_capacities", &_msttn::bond_capacities)
        .def("bond_capacities", [](const _msttn &o)
             {typename _msttn::hrank_info res;  o.bond_capacities(res);   return res; })

        .def("resize", static_cast<void (_msttn::*)(const ntree<size_t, std::allocator<size_t>> &, size_t, bool, bool)>(&_msttn::resize), py::arg(), py::arg(), py::arg("collapse_bond_matrices") = true, py::arg("purification") = false)
        .def("resize", static_cast<void (_msttn::*)(const ntree<size_t, std::allocator<size_t>> &, const ntree<size_t, std::allocator<size_t>> &, size_t, bool, bool)>(&_msttn::resize), py::arg(), py::arg(), py::arg(), py::arg("collapse_bond_matrices") = true, py::arg("purification") = false)
        .def("resize", static_cast<void (_msttn::*)(const std::string &, size_t, bool, bool)>(&_msttn::resize), py::arg(), py::arg(), py::arg("collapse_bond_matrices") = true, py::arg("purification") = false)
        .def("resize", static_cast<void (_msttn::*)(const std::string &, const std::string &, size_t, bool, bool)>(&_msttn::resize), py::arg(), py::arg(), py::arg(), py::arg("collapse_bond_matrices") = true, py::arg("purification") = false)
        ...
        */
        ...
        .def("__imul__", [](_msttn &a, const real_type &b)
             { return a *= b; })
        .def("__imul__", [](_msttn &a, const numpy_type &b)
             { return a *= T(b); })
        .def("__idiv__", [](_msttn &a, const real_type &b)
             { return a *= b; })
        .def("__idiv__", [](_msttn &a, const numpy_type &b)
             { return a *= T(b); })
        ...
        .def("__iter__", [](_msttn &s)
             { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>())

        .def_property("nthreads", static_cast<size_type (_msttn::*)() const>(&_msttn::nthreads), [](_msttn &o, const size_type &i)
                      { o.nthreads() = i; })
        .def("mode_dimensions", [](const _msttn &o)
             { return o.mode_dimensions(); })
        .def("dim", [](const _msttn &o, size_t i)
             { return o.dim(i); })
        .def("nmodes", [](const _msttn &o)
             { return o.nmodes(); })
        .def("is_purification", &_msttn::is_purification)
        .def("ntensors", [](const _msttn &o)
             { return o.ntensors(); })
        .def("nsites", [](const _msttn &o)
             { return o.ntensors(); })
        .def("nset", &_msttn::nset)
        .def("nelems", [](const _msttn &o)
             { return o.nelems(); })
        .def("__len__", [](const _msttn &o)
             { return o.nmodes(); })
        ...
        */
        .def("has_orthogonality_centre", [](const _msttn &o)
             { return o.has_orthogonality_centre(); })
        .def("orthogonality_centre", [](const _msttn &o)
             { return o.orthogonality_centre(); })
        .def("is_orthogonalised", [](const _msttn &o)
             { return o.is_orthogonalised(); })
        ...
        .def("shift_orthogonality_centre", &_msttn::shift_orthogonality_centre, py::arg(), py::arg("tol") = 0, py::arg("nchi") = 0)
        .def("set_orthogonality_centre", static_cast<void (_msttn::*)(size_t, double, size_t)>(&_msttn::set_orthogonality_centre), py::arg(), py::arg("tol") = 0, py::arg("nchi") = 0)
        .def("set_orthogonality_centre", static_cast<void (_msttn::*)(const std::list<size_t> &, double, size_t)>(&_msttn::set_orthogonality_centre), py::arg(), py::arg("tol") = 0, py::arg("nchi") = 0)
        .def("orthogonalise", &_msttn::orthogonalise, py::arg("force") = false)
        .def("truncate", &_msttn::truncate, py::arg("tol") = 0, py::arg("nchi") = 0)

        .def("normalise", &_msttn::normalise)
        .def("norm", &_msttn::norm)

        .def("__str__", [](const _msttn &o)
             {std::stringstream oss;   oss << o; return oss.str(); })

        .def("__setitem__", [](_msttn &i, size_t ind, const _msttn_node_data &o)
             { i[ind]() = o; })
...
void initialise_msttn_types(py::module &m)
{
...
#endif // PYTHON_BINDING_MS_TTN_TPP
