...
@pytest.mark.parametrize(
    "N, expected_result, adaptive, use_mps",
    [
        (16, -1.2510242438, False, True),
        (20, -1.255389856, False, True),
        (32, -1.2620097863, False, True),
        #(16, -1.2510242438, True, True),
        #(20, -1.255389856, True, True),
        #(32, -1.2620097863, True, True),
        (16, -1.2510242438, False, False),
        (20, -1.255389856, False, False),
        #(16, -1.2510242438, True, False),
        #(20, -1.255389856, True, False),
    ],
)
def test_dmrg_mps_tfim_cuda(N, expected_result, adaptive, use_mps):
    ...
    if adaptive:
        if use_mps:
            ...
            A = ttn(topo, capacity, dtype=np.complex128, backend='cuda')
        else:
        ...
        if use_mps:
            ...
            A = ttn(topo, dtype=np.complex128, backend='cuda')
        else:
...
@pytest.mark.parametrize(
    "N, expected_result, second_chain_interactions, adaptive",
    [
        (16, -1.2510242438, False, False),
        (20, -1.255389856, False, False),
        #(16, -1.2510242438, False, True),
...
def test_dmrg_mps_tfim_strided_cuda(N, expected_result, second_chain_interactions, adaptive):
    """Tests the DMRG algorithm on the transverse field Ising model at its critical point.
...
@pytest.mark.parametrize(
    "N, expected_result, adaptive",
    [
        (16, -1.2510242438, False),
        (20, -1.255389856, False),
        #(16, -1.2510242438, True),
        #(20, -1.255389856, True),
    ],
)
def test_dmrg_mps_tfim_fork_cuda(N, expected_result, adaptive):
    """Tests the DMRG algorithm on the transverse field Ising model at its critical point.
