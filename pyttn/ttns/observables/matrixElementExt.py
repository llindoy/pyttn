...
class MatrixElement(metaclass=ABCMeta):
    ...
    def __new__(
        ...
        **kwargs,
        ...
        this to construct a MatrixElement suitable for evaluating matrix elements of this class.  Otherwise this will construct an empty MatrixElement
    ...
    def assign(self, o):
        ...
        :param o: The other MatrixElement object
        :type o: MatrixElement
        """
        pass
