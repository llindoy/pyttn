...
def aaa_support_points(wmin=None, wmax = None, Naaa=1000, aaa_support_points = None):
...
def aaa_fit_correlation_function(Sw, wmin=None, wmax = None, aaa_tol = 1e-3, Naaa=1000, aaa_nmax=500, aaa_support_points = None)
    Z1 = aaa_support_points(wmin=None, wmax = None, Naaa=1000, aaa_support_points = None))
    Sw_aaa, dk, zk = setup_heom_correlation_functions(Sw, Z1, nmax=aaa_nmax, aaa_tol=self.aaa_tol)
    return dk, zk, Sw_aaa
