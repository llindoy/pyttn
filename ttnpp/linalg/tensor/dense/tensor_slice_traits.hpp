...
#ifndef PYTTN_LINALG_TENSOR_DENSE_TENSOR_SLICE_TRAITS_HPP_
#define PYTTN_LINALG_TENSOR_DENSE_TENSOR_SLICE_TRAITS_HPP_
...
namespace linalg
{
    ...
    struct tensor_slice_traits
    {
        ...
        static inline typename std::enable_if<_mutable, slice_type>::type make(container_pointer a, size_type i) { return slice_type(a, a->buffer(), i); }
...
#endif // PYTTN_LINALG_TENSOR_DENSE_TENSOR_SLICE_TRAITS_HPP_//
