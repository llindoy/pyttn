...
#ifndef PYTTN_LINALG_BACKENDS_CUSOLVER_WRAPPER_CUH_
#define PYTTN_LINALG_BACKENDS_CUSOLVER_WRAPPER_CUH_
...
namespace linalg
{
    namespace cusolver
    {
        ...
        template <>
        struct gesvd_params<std::complex<double>>
        {
            static inline void buffersize(cusolverDnHandle_t handle, int m, int n, int &lwork) { CALL_AND_RETHROW(cusolver_safe_call(cusolverDnZgesvd_bufferSize(handle, m, n, &lwork))); }
        };
...
#endif // PYTTN_LINALG_BACKENDS_CUSOLVER_WRAPPER_CUH_//
