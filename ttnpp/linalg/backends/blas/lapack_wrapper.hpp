...
#ifndef PYTTN_LINALG_BACKENDS_LAPACK_WRAPPER_HPP_
#define PYTTN_LINALG_BACKENDS_LAPACK_WRAPPER_HPP_
...
namespace linalg
{
    namespace lapack
    {
        ...
        extern "C"
        {
            ...
            void cgesvd_(const char *JOBU, const char *JOBVT, const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, float *S, std::complex<float> *U, const blas_int_type *LDU, std::complex<float> *VT, const blas_int_type *LDVT, std::complex<float> *WORK, const blas_int_type *LWORK, float *RWORK, blas_int_type *INFO);
            void zgesvd_(const char *JOBU, const char *JOBVT, const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, double *S, std::complex<double> *U, const blas_int_type *LDU, std::complex<double> *VT, const blas_int_type *LDVT, std::complex<double> *WORK, const blas_int_type *LWORK, double *RWORK, blas_int_type *INFO);
            ...
            void cgesdd_(const char *JOBZ, const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, float *S, std::complex<float> *U, const blas_int_type *LDU, std::complex<float> *VT, const blas_int_type *LDVT, std::complex<float> *WORK, const blas_int_type *LWORK, float *RWORK, blas_int_type *IWORK, blas_int_type *INFO);
            void zgesdd_(const char *JOBZ, const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, double *S, std::complex<double> *U, const blas_int_type *LDU, std::complex<double> *VT, const blas_int_type *LDVT, std::complex<double> *WORK, const blas_int_type *LWORK, double *RWORK, blas_int_type *IWORK, blas_int_type *INFO);
            ...
            void cgeqp3_(const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, blas_int_type *JPVT, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type *LWORK, float *RWORK, blas_int_type *INFO);
            void zgeqp3_(const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, blas_int_type *JPVT, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type *LWORK, double *RWORK, blas_int_type *INFO);
            ...
            void cgeqrf_(const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            void zgeqrf_(const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void cungqr_(const blas_int_type *M, const blas_int_type *N, const blas_int_type *K, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            void zungqr_(const blas_int_type *M, const blas_int_type *N, const blas_int_type *K, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void cgelqf_(const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            void zgelqf_(const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void cunglq_(const blas_int_type *M, const blas_int_type *N, const blas_int_type *K, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            void zunglq_(const blas_int_type *M, const blas_int_type *N, const blas_int_type *K, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void chseqr_(const char *JOB, const char *COMPZ, const blas_int_type *N, const blas_int_type *ILO, const blas_int_type *IHI, std::complex<float> *H, const blas_int_type *LDH, std::complex<float> *W, std::complex<float> *Z, const blas_int_type *LDZ, std::complex<float> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            void zhseqr_(const char *JOB, const char *COMPZ, const blas_int_type *N, const blas_int_type *ILO, const blas_int_type *IHI, std::complex<double> *H, const blas_int_type *LDH, std::complex<double> *W, std::complex<double> *Z, const blas_int_type *LDZ, std::complex<double> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void ctrevc_(const char *SIDE, const char *HOWMNY, const bool *SELECT, const blas_int_type *N, std::complex<float> *T, const blas_int_type *LDT, std::complex<float> *VL, const blas_int_type *LDVL, std::complex<float> *VR, const blas_int_type *LDVR, const blas_int_type *MM, const blas_int_type *M, std::complex<float> *WORK, float *RWORK, blas_int_type *INFO);
            void ztrevc_(const char *SIDE, const char *HOWMNY, const bool *SELECT, const blas_int_type *N, std::complex<double> *T, const blas_int_type *LDT, std::complex<double> *VL, const blas_int_type *LDVL, std::complex<double> *VR, const blas_int_type *LDVR, const blas_int_type *MM, const blas_int_type *M, std::complex<double> *WORK, double *RWORK, blas_int_type *INFO);
            ...
            void cgeev_(const char *JOBVL, const char *JOBVR, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *W, std::complex<float> *VL, const blas_int_type *LDVL, std::complex<float> *VR, const blas_int_type *LDVR, std::complex<float> *WORK, const blas_int_type *LWORK, float *RWORK, blas_int_type *INFO);
            void zgeev_(const char *JOBVL, const char *JOBVR, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *W, std::complex<double> *VL, const blas_int_type *LDVL, std::complex<double> *VR, const blas_int_type *LDVR, std::complex<double> *WORK, const blas_int_type *LWORK, double *RWORK, blas_int_type *INFO);
            ...
            void cheev_(const char *JOBZ, const char *UPLO, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, float *W, std::complex<float> *WORK, const blas_int_type *LWORK, float *RWORK, blas_int_type *INFO);
            void zheev_(const char *JOBZ, const char *UPLO, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, double *W, std::complex<double> *WORK, const blas_int_type *LWORK, double *RWORK, blas_int_type *INFO);
            ...
            // void cstedc_(const char* COMPZ, const blas_int_type* N,  std::complex<float>* D,  std::complex<float>* E,  std::complex<float>* Z, const blas_int_type* LDZ,  std::complex<float>* WORK, const blas_int_type* LWORK,  float* RWORK, const blas_int_type* LRWORK, blas_int_type* IWORK, const blas_int_type* LIWORK, blas_int_type* INFO);
            // void zstedc_(const char* COMPZ, const blas_int_type* N,  std::complex<double>* D,  std::complex<double>* E,  std::complex<double>* Z, const blas_int_type* LDZ,  std::complex<double>* WORK, const blas_int_type* LWORK,  double* RWORK, const blas_int_type* LRWORK, blas_int_type* IWORK, const blas_int_type* LIWORK, blas_int_type* INFO);
            ...
            void chetrd_(const char *UPLO, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, float *D, float *E, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            void zhetrd_(const char *UPLO, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, double *D, double *E, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void cunmtr_(const char *side, const char *UPLO, const char *TRANS, const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *TAU, std::complex<float> *C, const blas_int_type *LDC, std::complex<float> *work, const blas_int_type *LWORK, blas_int_type *INFO);
            void zunmtr_(const char *side, const char *UPLO, const char *TRANS, const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *TAU, std::complex<double> *C, const blas_int_type *LDC, std::complex<double> *work, const blas_int_type *LWORK, blas_int_type *INFO);
            ...
            void cgetrf_(const blas_int_type *M, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, blas_int_type *IPIV, blas_int_type *INFO);
            void zgetrf_(const blas_int_type *M, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, blas_int_type *IPIV, blas_int_type *INFO);
            ...
            void cgetrs_(const char *TRANS, const blas_int_type *N, const blas_int_type *NRHS, std::complex<float> *A, const blas_int_type *LDA, blas_int_type *IPIV, std::complex<float> *B, const blas_int_type *LDB, blas_int_type *INFO);
            void zgetrs_(const char *TRANS, const blas_int_type *N, const blas_int_type *NRHS, std::complex<double> *A, const blas_int_type *LDA, blas_int_type *IPIV, std::complex<double> *B, const blas_int_type *LDB, blas_int_type *INFO);
            ...
            void cggev_(const char *JOBVL, const char *JOBVR, const blas_int_type *N, std::complex<float> *A, const blas_int_type *LDA, std::complex<float> *B, const blas_int_type *LDB, std::complex<float> *ALPHA, std::complex<float> *BETA, std::complex<float> *VL, const blas_int_type *LDVL, std::complex<float> *VR, const blas_int_type *LDVR, std::complex<float> *WORK, const blas_int_type *LWORK, const float *RWORK, blas_int_type *INFO);
            void zggev_(const char *JOBVL, const char *JOBVR, const blas_int_type *N, std::complex<double> *A, const blas_int_type *LDA, std::complex<double> *B, const blas_int_type *LDB, std::complex<double> *ALPHA, std::complex<double> *BETA, std::complex<double> *VL, const blas_int_type *LDVL, std::complex<double> *VR, const blas_int_type *LDVR, std::complex<double> *WORK, const blas_int_type *LWORK, const double *RWORK, blas_int_type *INFO);
        }
#endif
...
#endif // PYTTN_LINALG_BACKENDS_LAPACK_WRAPPER_HPP_//
