...
#ifndef PYTTN_LINALG_BACKENDS_BLAS_WRAPPER_HPP_
#define PYTTN_LINALG_BACKENDS_BLAS_WRAPPER_HPP_
...
namespace linalg
{
    namespace blas
    {
        ...
        static inline void axpy(const blas_int_type *const N, const std::complex<float> *const A, const std::complex<float> *const X, const blas_int_type *const INCX, std::complex<float> *const Y, const blas_int_type *const INCY)
        {
        ...
        static inline void axpy(const blas_int_type *const N, const std::complex<double> *const A, const std::complex<double> *const X, const blas_int_type *const INCX, std::complex<double> *const Y, const blas_int_type *const INCY)
        {
        ...
        static inline void scal(const blas_int_type *const N, const std::complex<float> *const A, std::complex<float> *const X, const blas_int_type *const INCX)
        {
            using ctype = const std::complex<float> *;
            using type = std::complex<float> *;
            cscal_(N, reinterpret_cast<ctype>(A), reinterpret_cast<type>(X), INCX);
        }
        static inline void scal(const blas_int_type *const N, const std::complex<double> *const A, std::complex<double> *const X, const blas_int_type *const INCX)
        {
            using ctype = const std::complex<double> *;
            using type = std::complex<double> *;
        ...
        static inline void gemv(char *const TRANSA, const blas_int_type *const M, const blas_int_type *const N, const std::complex<float> *const ALPHA, const std::complex<float> *const A, const blas_int_type *const LDA, const std::complex<float> *const X, const blas_int_type *const INCX, const std::complex<float> *const BETA, std::complex<float> *const Y, const blas_int_type *const INCY)
        {
            using ctype = const std::complex<float> *;
            using type = std::complex<float> *;
        ...
        static inline void gemv(char *const TRANSA, const blas_int_type *const M, const blas_int_type *const N, const std::complex<double> *const ALPHA, const std::complex<double> *const A, const blas_int_type *const LDA, const std::complex<double> *const X, const blas_int_type *const INCX, const std::complex<double> *const BETA, std::complex<double> *const Y, const blas_int_type *const INCY)
        {
            using ctype = const std::complex<double> *;
            using type = std::complex<double> *;
        ...
        static inline void gemm(char *const TRANSA, char *const TRANSB, const blas_int_type *const M, const blas_int_type *const N, const blas_int_type *const K, const std::complex<float> *const ALPHA, const std::complex<float> *const A, const blas_int_type *const LDA, const std::complex<float> *const B, const blas_int_type *const LDB, const std::complex<float> *const BETA, std::complex<float> *const C, const blas_int_type *const LDC)
        {
            using ctype = const std::complex<float> *;
            using type = std::complex<float> *;
        ...
        static inline void gemm(char *const TRANSA, char *const TRANSB, const blas_int_type *const M, const blas_int_type *const N, const blas_int_type *const K, const std::complex<double> *const ALPHA, const std::complex<double> *const A, const blas_int_type *const LDA, const std::complex<double> *const B, const blas_int_type *const LDB, const std::complex<double> *const BETA, std::complex<double> *const C, const blas_int_type *const LDC)
        {
            using ctype = const std::complex<double> *;
            using type = std::complex<double> *;
        ...
        static inline void conj(int N, const std::complex<float> *const X, int INCX, std::complex<float> *const Y, int INCY)
        {
            using linalg::conj;
            for (int i = 0; i < N; ++i)
            {
                Y[i * INCY] = conj(X[i * INCX]);
            }
        }
        static inline void conj(int N, const std::complex<double> *const X, int INCX, std::complex<double> *const Y, int INCY)
        {
            using linalg::conj;
            for (int i = 0; i < N; ++i)
            {
        ...
        static inline std::complex<float> dot(bool conj, const blas_int_type *const N, const std::complex<float> *const X, const blas_int_type *const INCX, const std::complex<float> *const Y, const blas_int_type *const INCY)
        {
            using ctype = const std::complex<float> *;
            ...
            if (conj)
            {
                cdotc(reinterpret_cast<cctype>(&ret), N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
            else
            {
                cdotu(reinterpret_cast<cctype>(&ret), N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
            return ret;
        }
        static inline std::complex<double> dot(bool conj, const blas_int_type *const N, const std::complex<double> *const X, const blas_int_type *const INCX, const std::complex<double> *const Y, const blas_int_type *const INCY)
        {
            using ctype = const std::complex<double> *;
            ...
            if (conj)
            {
                zdotc(reinterpret_cast<cctype>(&ret), N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
            else
            {
                zdotu(reinterpret_cast<cctype>(&ret), N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
            return ret;
        }
#else
        static inline std::complex<float> dot(bool conj, const blas_int_type *const N, const std::complex<float> *const X, const blas_int_type *const INCX, const std::complex<float> *const Y, const blas_int_type *const INCY)
        {
            ...
            if (conj)
            {
                return cdotc(N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
            else
            {
                return cdotu(N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
        }
        static inline std::complex<double> dot(bool conj, const blas_int_type *const N, const std::complex<double> *const X, const blas_int_type *const INCX, const std::complex<double> *const Y, const blas_int_type *const INCY)
        {
            ...
            if (conj)
            {
                return zdotc(N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
            else
            {
                return zdotu(N, reinterpret_cast<ctype>(X), INCX, reinterpret_cast<ctype>(Y), INCY);
            }
        }
#endif
...
#endif // PYTTN_LINALG_BACKENDS_BLAS_WRAPPER_HPP_//
