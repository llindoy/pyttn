...
#ifndef PYTTN_LINALG_BACKENDS_MKL_WRAPPER_HPP_
#define PYTTN_LINALG_BACKENDS_MKL_WRAPPER_HPP_
...
namespace linalg
{
    namespace mkl_extensions
    {
        ...
        void gemm3m(char TRANSA, char TRANSB, blas_int_type M, blas_int_type N, blas_int_type K, std::complex<float> ALPHA, const std::complex<float> *A,
                    blas_int_type LDA, const std::complex<float> *B, blas_int_type LDB, std::complex<float> BETA, std::complex<float> *C, blas_int_type LDC)
        {
            cgemm3m(&TRANSA, &TRANSB, &M, &N, &K, &ALPHA, A, &LDA, B, &LDB, &BETA, C, &LDC);
        }

        void gemm3m(char TRANSA, char TRANSB, blas_int_type M, blas_int_type N, blas_int_type K, std::complex<double> ALPHA, const std::complex<double> *A,
                    blas_int_type LDA, const std::complex<double> *B, blas_int_type LDB, std::complex<double> BETA, std::complex<double> *C, blas_int_type LDC)
        {
        ...
        void batched_strided_gemm(char TRANSA, char TRANSB, blas_int_type M, blas_int_type N, blas_int_type K, std::complex<float> ALPHA, const std::complex<float> *A,
                                  blas_int_type LDA, blas_int_type strideA, const std::complex<float> *B, blas_int_type LDB, blas_int_type strideB, std::complex<float> BETA, std::complex<float> *C, blas_int_type LDC,
                                  blas_int_type strideC, blas_int_type batchCount)
        {
            CBLAS_TRANSPOSE transa = get_cblas_transpose(TRANSA);
            CBLAS_TRANSPOSE transb = get_cblas_transpose(TRANSB);
        ...
        void batched_strided_gemm(char TRANSA, char TRANSB, blas_int_type M, blas_int_type N, blas_int_type K, std::complex<double> ALPHA, const std::complex<double> *A,
                                  blas_int_type LDA, blas_int_type strideA, const std::complex<double> *B, blas_int_type LDB, blas_int_type strideB, std::complex<double> BETA, std::complex<double> *C, blas_int_type LDC,
                                  blas_int_type strideC, blas_int_type batchCount)
        {
            CBLAS_TRANSPOSE transa = get_cblas_transpose(TRANSA);
            CBLAS_TRANSPOSE transb = get_cblas_transpose(TRANSB);
...
#endif // PYTTN_LINALG_BACKENDS_MKL_WRAPPER_HPP_
