...
#pragma omp parallel for schedule(static)
    ...
    public:
        ...
        template <typename T>
        static inline typename std::enable_if<is_valid_value_type<T>::value, void>::type complex_conjugate(blas_int_type /*size*/, const T *const /*X*/, T *const /*Y*/) {}
        template <typename T>
        static inline typename std::enable_if<is_valid_value_type<std::complex<T>>::value, void>::type complex_conjugate(blas_int_type size, const std::complex<T> *const X, std::complex<T> *const Y)
        {
            for (blas_int_type i = 0; i < size; ++i)
            {
                Y[i] = conj(X[i]);
            }
        }
    ...
    public:
        ...
        template <typename T>
        static inline void csrmv(transform_type opA, bool conjB, blas_int_type m, blas_int_type /*n*/, size_type /*nnz*/, std::complex<T> alpha, const std::complex<T> *A, const int *rowptr, const int *colind, const std::complex<T> *X, blas_int_type incx, std::complex<T> beta, std::complex<T> *Y, blas_int_type incy)
        {
            ASSERT(opA == op_c || opA == op_n, "Failed to compute csrmv.  Transposed csr matrices are currently not supported.");
            if (opA == op_c)
            {
    ...
    public:
        ...
        static inline void sytrd(const char uplo, const blas_int_type n, std::complex<float> *a, const blas_int_type lda, float *d, float *e, std::complex<float> *tau, std::complex<float> *work, const blas_int_type lwork)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static inline void sytrd(const char uplo, const blas_int_type n, std::complex<double> *a, const blas_int_type lda, double *d, double *e, std::complex<double> *tau, std::complex<double> *work, const blas_int_type lwork)
        {
            blas_int_type info;
            using namespace lapack;
    ...
    public:
        ...
        static inline void ormtr(const char side, const char uplo, const char trans, const blas_int_type m, const blas_int_type n, std::complex<float> *a, const blas_int_type lda, std::complex<float> *tau, std::complex<float> *c, const blas_int_type ldc, std::complex<float> *work, const blas_int_type lwork)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static inline void ormtr(const char side, const char uplo, const char trans, const blas_int_type m, const blas_int_type n, std::complex<double> *a, const blas_int_type lda, std::complex<double> *tau, std::complex<double> *c, const blas_int_type ldc, std::complex<double> *work, const blas_int_type lwork)
        {
            blas_int_type info;
            using namespace lapack;
    ...
    public:
        ...
        static inline void ggev(const char JOBVL, const char JOBVR, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, std::complex<float> *B, const blas_int_type LDB, std::complex<float> *W, std::complex<float> *beta, std::complex<float> *VL, const blas_int_type LDVL, std::complex<float> *VR, const blas_int_type LDVR, std::complex<float> *WORK, const blas_int_type LWORK, float *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void ggev(const char JOBVL, const char JOBVR, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, std::complex<double> *B, const blas_int_type LDB, std::complex<double> *W, std::complex<double> *beta, std::complex<double> *VL, const blas_int_type LDVL, std::complex<double> *VR, const blas_int_type LDVR, std::complex<double> *WORK, const blas_int_type LWORK, double *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        static inline void stev(const char COMPZ, const blas_int_type N, float *D, float *E, float *Z, const blas_int_type LDZ, float *WORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void stev(const char COMPZ, const blas_int_type N, double *D, double *E, double *Z, const blas_int_type LDZ, double *WORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        //    static inline void stev(const char COMPZ, const blas_int_type N, std::complex<float>* D, std::complex<float>* E, std::complex<float>* Z, const blas_int_type LDZ, std::complex<float>* WORK, const blas_int_type LWORK, float* RWORK, const blas_int_type LRWORK, int* IWORK, const blas_int_type LIWORK)
        ...
        //    static inline void stev(const char COMPZ, const blas_int_type N, std::complex<double>* D, std::complex<double>* E, std::complex<double>* Z, const blas_int_type LDZ, std::complex<double>* WORK, const blas_int_type LWORK, double* RWORK, const blas_int_type LRWORK, int* IWORK, const blas_int_type LIWORK)
    ...
    public:
        ...
        static inline void heev(const char JOBZ, const char UPLO, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, float *W, std::complex<float> *WORK, const blas_int_type LWORK, float *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void heev(const char JOBZ, const char UPLO, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, double *W, std::complex<double> *WORK, const blas_int_type LWORK, double *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline void geev(const char JOBVL, const char JOBVR, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, std::complex<float> *W, std::complex<float> *VL, const blas_int_type LDVL, std::complex<float> *VR, const blas_int_type LDVR, std::complex<float> *WORK, const blas_int_type LWORK, float *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void geev(const char JOBVL, const char JOBVR, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, std::complex<double> *W, std::complex<double> *VL, const blas_int_type LDVL, std::complex<double> *VR, const blas_int_type LDVR, std::complex<double> *WORK, const blas_int_type LWORK, double *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline void hseqr(const char JOB, const char COMPZ, const blas_int_type N, const blas_int_type ILO, const blas_int_type IHI, std::complex<float> *H, const blas_int_type LDH, std::complex<float> *W, std::complex<float> *Z, const blas_int_type LDZ, std::complex<float> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void hseqr(const char JOB, const char COMPZ, const blas_int_type N, const blas_int_type ILO, const blas_int_type IHI, std::complex<double> *H, const blas_int_type LDH, std::complex<double> *W, std::complex<double> *Z, const blas_int_type LDZ, std::complex<double> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline blas_int_type trevc(const char SIDE, const char HOWMNY, select_type *SELECT, const blas_int_type N, std::complex<float> *T, const blas_int_type LDT, std::complex<float> *VL, const blas_int_type LDVL, std::complex<float> *VR, const blas_int_type LDVR, const blas_int_type MM, std::complex<float> *WORK, float *RWORK)
        {
            blas_int_type INFO, M;
            M = 0;
            using namespace lapack;
        ...
        static inline blas_int_type trevc(const char SIDE, const char HOWMNY, select_type *SELECT, const blas_int_type N, std::complex<double> *T, const blas_int_type LDT, std::complex<double> *VL, const blas_int_type LDVL, std::complex<double> *VR, const blas_int_type LDVR, const blas_int_type MM, std::complex<double> *WORK, double *RWORK)
        {
            blas_int_type INFO, M;
            M = 0;
            using namespace lapack;
        ...
        static void getrf(const blas_int_type M, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, int *IPIV)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static void getrf(const blas_int_type M, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, int *IPIV)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static void getrs(const char TRANS, const blas_int_type N, const blas_int_type NRHS, std::complex<float> *A, const blas_int_type LDA, int *IPIV, std::complex<float> *B, const blas_int_type LDB)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static void getrs(const char TRANS, const blas_int_type N, const blas_int_type NRHS, std::complex<double> *A, const blas_int_type LDA, int *IPIV, std::complex<double> *B, const blas_int_type LDB)
        {
            blas_int_type info;
            using namespace lapack;
    ...
    public:
        ...
        static void gesvd(const char jobu, const char jobv, const blas_int_type m, const blas_int_type n, std::complex<float> *A, const blas_int_type lda, float *S, std::complex<float> *U, const blas_int_type ldu, std::complex<float> *vt, const blas_int_type ldvt, std::complex<float> *work, const blas_int_type lwork, float *rwork)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static void gesvd(const char jobu, const char jobv, const blas_int_type m, const blas_int_type n, std::complex<double> *A, const blas_int_type lda, double *S, std::complex<double> *U, const blas_int_type ldu, std::complex<double> *vt, const blas_int_type ldvt, std::complex<double> *work, const blas_int_type lwork, double *rwork)
        {
            blas_int_type info;
            using namespace lapack;
    ...
    public:
        ...
        static void gesdd(const char jobz, const blas_int_type m, const blas_int_type n, std::complex<float> *A, const blas_int_type lda, float *S, std::complex<float> *U, const blas_int_type ldu, std::complex<float> *vt, const blas_int_type ldvt, std::complex<float> *work, const blas_int_type lwork, float *rwork, int *iwork)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static void gesdd(const char jobz, const blas_int_type m, const blas_int_type n, std::complex<double> *A, const blas_int_type lda, double *S, std::complex<double> *U, const blas_int_type ldu, std::complex<double> *vt, const blas_int_type ldvt, std::complex<double> *work, const blas_int_type lwork, double *rwork, int *iwork)
        {
            blas_int_type info;
            using namespace lapack;
        ...
        static inline void expand_svd_vects(blas_int_type nt, T *A, blas_int_type ni, blas_int_type nf, T *work)
        {
            if (ni != nf)
            {
                ...
                {
                    blas_int_type ia = i * ni;
                    blas_int_type iw = i * nf;
                    for (blas_int_type j = 0; j < ni; ++j)
                    {
                        work[iw + j] = A[ia + j];
                    }
                    for (blas_int_type j = ni; j < nf; ++j)
                    {
                        work[iw + j] = T(0.0);
                    }
                }
    ...
    public:
        ...
        static inline void geqp3(const blas_int_type M, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, blas_int_type *JPVT, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type LWORK, float *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void geqp3(const blas_int_type M, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, blas_int_type *JPVT, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type LWORK, double *RWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline void geqrf(const blas_int_type M, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void geqrf(const blas_int_type M, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline void ungqr(const blas_int_type M, const blas_int_type N, const blas_int_type K, std::complex<float> *A, const blas_int_type LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void ungqr(const blas_int_type M, const blas_int_type N, const blas_int_type K, std::complex<double> *A, const blas_int_type LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline void gelqf(const blas_int_type M, const blas_int_type N, std::complex<float> *A, const blas_int_type LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void gelqf(const blas_int_type M, const blas_int_type N, std::complex<double> *A, const blas_int_type LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
    ...
    public:
        ...
        static inline void unglq(const blas_int_type M, const blas_int_type N, const blas_int_type K, std::complex<float> *A, const blas_int_type LDA, std::complex<float> *TAU, std::complex<float> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
        ...
        static inline void unglq(const blas_int_type M, const blas_int_type N, const blas_int_type K, std::complex<double> *A, const blas_int_type LDA, std::complex<double> *TAU, std::complex<double> *WORK, const blas_int_type LWORK)
        {
            blas_int_type INFO;
            using namespace lapack;
