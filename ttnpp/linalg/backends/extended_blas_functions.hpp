...
namespace linalg
{
    namespace eblas_kernels
    {
        ...
        {
            template <typename T, typename OPA>
            static inline void eval(int /* m */, int /* n */, const T & /* alpha */, const T *linalg_restrict /* A */, const T & /* beta */, T *linalg_restrict /* B */, OPA && /* opa */) { RAISE_EXCEPTION("Should never get here"); }
            template <typename T, typename OPA>
            static inline void eval(int /* m */, int /* n */, int /* batchCount */, const T & /* alpha */, const T *linalg_restrict /* A */, const T & /* beta */, T *linalg_restrict /* B */, OPA && /* opa */) { RAISE_EXCEPTION("Should never get here"); }
        };
