...
#ifndef PYTTN_LINALG_ALGEBRA_OVERLOADS_SCALAR_MULTIPLICATION_HPP_
#define PYTTN_LINALG_ALGEBRA_OVERLOADS_SCALAR_MULTIPLICATION_HPP_
...
namespace linalg
{
    ...
    scal_gemm_return_type<T3, T1, T2> operator*(const T3 &l, const expression_templates::matrix_matrix_product<T1, T2> &r) { return expression_templates::matrix_matrix_product<T1, T2>(r, l); }
    template <typename T1, typename T2, typename T3>
    scal_gemm_return_type<T3, T1, T2> operator*(const expression_templates::matrix_matrix_product<T1, T2> &l, const T3 &r) { return expression_templates::matrix_matrix_product<T1, T2>(l, r); }

    template <typename T1, typename T2, typename T3>
    scal_gemv_return_type<T3, T1, T2> operator*(const T3 &l, const expression_templates::matrix_vector_product<T1, T2> &r) { return expression_templates::matrix_vector_product<T1, T2>(r, l); }
    template <typename T1, typename T2, typename T3>
    scal_gemv_return_type<T3, T1, T2> operator*(const expression_templates::matrix_vector_product<T1, T2> &l, const T3 &r) { return expression_templates::matrix_vector_product<T1, T2>(l, r); }
...
#endif // PYTTN_LINALG_ALGEBRA_OVERLOADS_SCALAR_MULTIPLICATION_HPP_//
