...
#ifndef PYTTN_LINALG_ALGEBRA_EXPRESSIONS_ELEMENTAL_APPLICATIVE_ADDITION_HPP_
#define PYTTN_LINALG_ALGEBRA_EXPRESSIONS_ELEMENTAL_APPLICATIVE_ADDITION_HPP_
...
namespace linalg
{
    ...
    namespace expression_templates
    {
        ...
        template <>
        class addition_op<blas_backend>
        {
        public:
        ...
        template <>
        class addition_op<cuda_backend>
        {
        public:
...
#endif // PYTTN_LINALG_ALGEBRA_EXPRESSIONS_ELEMENTAL_APPLICATIVE_ADDITION_HPP_
