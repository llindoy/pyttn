...
#ifndef PYTTN_LINALG_ALGEBRA_EXPRESSIONS_ELEMENTAL_RESULT_TYPE_HPP_
...
namespace linalg
{
    namespace expression_templates
    {
        ...
        struct result_type<literal_type<T, backend>>
        {
        ...
        struct result_type<tensor<T, D, backend>>
        {
            using value_type = T;
            using backend_type = backend;
        ...
        template <typename ArrType, typename T, size_t D>
        struct result_type<tensor_slice<ArrType, T, D>>
        {
            using value_type = T;
        ...
        template <typename T, size_t D, typename backend>
        struct result_type<reinterpreted_tensor<T, D, backend>>
        {
            using value_type = T;
            using backend_type = backend;
            static constexpr size_t rank = D;
        ...
        template <typename T, typename backend>
        struct result_type<hermitian_matrix<T, backend>>
        {
            using value_type = T;
            using backend_type = backend;
        ...
        template <typename T, typename backend>
        struct result_type<upper_hessenberg_matrix<T, backend>>
        {
            using value_type = T;
            using backend_type = backend;
            static constexpr size_t rank = 2;
        ...
        template <typename T, typename backend>
        struct result_type<csr_matrix<T, backend>>
        {
            using value_type = T;
            using backend_type = backend;
            static constexpr size_t rank = 2;
        ...
        template <typename T, typename backend>
        struct result_type<symmetric_tridiagonal_matrix<T, backend>>
        {
            using value_type = T;
            using backend_type = backend;
            static constexpr size_t rank = 2;
        ...
        template <typename T, typename backend>
        struct result_type<diagonal_matrix<T, backend>>
        {
            using value_type = T;
            using backend_type = backend;
            static constexpr size_t rank = 2;
        ...
        struct result_type<arr1, arr2, addition_op<backend>>
        {
            ...
            // the value type
            using vt1 = typename result_type<arr1>::value_type;
...
#endif // PYTTN_LINALG_ALGEBRA_EXPRESSIONS_ELEMENTAL_RESULT_TYPE_HPP_//
