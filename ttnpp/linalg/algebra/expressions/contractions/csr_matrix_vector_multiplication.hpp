...
#ifndef PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_CSR_MATRIX_VECTOR_MULTIPLICATION_HPP_
#define PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_CSR_MATRIX_VECTOR_MULTIPLICATION_HPP_
    ...
    namespace expression_templates
    {
        ...
        class matrix_vector_product<sparse_type, dense_type,
                                    typename std::enable_if<is_dense_vector<dense_type>::value &&
                                                            ...
                                                            void>::type> : public matrix_vector_product_base<matrix_vector_product<sparse_type, dense_type, void>>
        {
        public:
...
#endif // PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_CSR_MATRIX_VECTOR_MULTIPLICATION_HPP_
