...
#ifndef PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_DENSE_DENSE_MATRIX_MULTIPLICATION_HPP_
#define PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_DENSE_DENSE_MATRIX_MULTIPLICATION_HPP_
    ...
    namespace expression_templates
    {
        ...
        public:
            ...
            try : base_type(o, make_transpose, conjugate)
            {
                if (make_transpose)
                {
                    m_Abuffer = o.m_Bbuffer;
                    m_Bbuffer = o.m_Abuffer;
                    m_Asize = o.m_Bsize;
                    m_Bsize = o.m_Asize;
                    m_ldA = o.m_ldB;
                    m_ldB = o.m_ldA;
...
#endif // PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_DENSE_DENSE_MATRIX_MULTIPLICATION_HPP_
