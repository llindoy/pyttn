...
#ifndef PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_CSR_MATRIX_DENSE_MATRIX_MULTIPLICATION_HPP_
#define PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_CSR_MATRIX_DENSE_MATRIX_MULTIPLICATION_HPP_
    ...
    namespace expression_templates
    {
        ...
        class matrix_matrix_product<sparse_type, dense_type,
                                    typename std::enable_if<is_dense_matrix<dense_type>::value &&
                                                            ...
                                                            void>::type> : public matrix_matrix_product_base<matrix_matrix_product<sparse_type, dense_type, void>>
        {
        public:
...
#endif // PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_CSR_MATRIX_DENSE_MATRIX_MULTIPLICATION_HPP_
