...
#ifndef PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_MATRIX_VECTOR_MULTIPLICATION_BASE_HPP_
#define PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_MATRIX_VECTOR_MULTIPLICATION_BASE_HPP_
    ...
    namespace expression_templates
    {
        ...
        public:
            ...
            matrix_vector_product_base(const matrix_vector_product_base &o, bool conjugate = false) : base_type(shape_type{{0}}), m_working(o.m_working), m_working_size(o.m_working_size)
            {
                ...
                case (backend_type::op_n):
                {
                    m_opX = conjugate ? backend_type::op_c : backend_type::op_n;
                    break;
                };
                case (backend_type::op_c):
                {
                    m_opX = conjugate ? backend_type::op_n : backend_type::op_c;
                    break;
                };
                }
            }
...
#endif // PYTTN_LINALG_ALGEBRA_EXPRESSIONS_CONTRACTIONS_MATRIX_VECTOR_MULTIPLICATION_BASE_HPP_//
