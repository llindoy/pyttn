...
namespace linalg
{
    ...
    class generic_tensor_type : linalg_type
    {
    };
    template <size_t D>
    class tensor_type : public generic_tensor_type
    {
    ...
    class is_const_expression_type : public generic_expression_type
    {
    };
    template <size_t D, bool copyassignable>
    class expression_type : public is_const_expression_type<copyassignable>
    {
        static constexpr size_t rank = D;
    };
    ...
    template <size_t D>
    class dense_tensor_type : public dense_type, public tensor_type<D>
    {
    };
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename ArrRef>
    class tensor_base;
    template <typename T, size_t D, typename backend = blas_backend>
    class tensor;

    // dense tensor views
    template <typename SliceRef>
    class tensor_slice_base;
    template <typename Arr, typename data_type, size_t D>
    class tensor_slice;
    template <typename Arr, typename data_type, size_t D>
    ...
    template <typename T, typename backend = blas_backend>
    class upper_hessenberg_matrix;

    // sparse views of dense matrices
    template <typename ArrRef>
    class diagonal_matrix_view_base;
    ...
    template <typename T, typename backend = blas_backend>
    class symmetric_tridiagonal_matrix;

    template <typename ViewRef>
    class triangular_matrix_base;
    template <typename T, typename backend = blas_backend>
    ...
    namespace expression_templates
    {
        ...
        template <typename impl>
        class matrix_matrix_product_base;
        template <typename T1, typename T2, class enabled = void>
        class matrix_matrix_product;
        template <typename a_tensor_type, typename b_tensor_type, size_t D, class enabled = void>
        class tensordot_expr;

        template <typename T1, typename T2>
        class tensor_contraction_1_mt;
        template <typename T1, typename T2>
        class tensor_contraction_332;

        // declare the different operation types we support through expression trees
        template <typename backend>
        class addition_op;
        template <typename backend>
        class multiplication_op;
        template <typename backend>
        class conjugation_op;
        template <typename backend>
        class hadamard_op;
        template <typename backend>
        class complex_op;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename matrix_type, typename enabled = void>
    class generalised_eigensolver;
    template <typename matrix_type, typename enabled = void>
    class eigensolver;
    template <typename matrix_type, typename enabled = void>
    class tridiagonalisation;
    template <typename matrix_type, bool use_divide_and_conquer = true, typename enabled = void>
    ...
    template <typename matrix_type, bool use_lu = true, typename enabler = void>
    class determinant;
    template <typename matrix_type, bool use_lu = true, typename enabler = void>
    class linear_solver;
