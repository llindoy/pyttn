...
namespace linalg
{
    namespace memory
    {
        ...
        public:
            ExecDomain() : m_mpi_rank(0), m_gpu_id(0) {}
            ExecDomain(int mpi_rank, int gpu_id) : m_mpi_rank(mpi_rank), m_gpu_id(gpu_id){}
        ...
        public:
            ExecContext(const ExecDomain<cuda_backend>& domain, std::size_t id = 0) : m_domain(domain), m_id(id) {}
