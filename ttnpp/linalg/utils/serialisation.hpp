...
namespace cereal
{
    ...
    void save(archive &ar, const complex<float> &val) { ar(cereal::make_nvp("real", val.real()), cereal::make_nvp("imag", val.imag())); }
    template <typename archive>
    void load(archive &ar, complex<float> &val)
    {
        float v;
    ...
    template <typename archive>
    void save(archive &ar, const complex<double> &val) { ar(cereal::make_nvp("real", val.real()), cereal::make_nvp("imag", val.imag())); }
    template <typename archive>
    void load(archive &ar, complex<double> &val)
    {
        double v;
        ar(cereal::make_nvp("real", v));
        val.real(v);
