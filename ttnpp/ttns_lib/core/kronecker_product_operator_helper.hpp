...
#ifndef PYTTN_TTNS_LIB_CORE_KRONECKER_PRODUCT_OPERATOR_HELPER_HPP_
#define PYTTN_TTNS_LIB_CORE_KRONECKER_PRODUCT_OPERATOR_HELPER_HPP_
...
#endif // PYTTN_TTNS_LIB_CORE_KRONECKER_PRODUCT_OPERATOR_HELPER_HPP_//
