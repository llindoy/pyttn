...
#ifndef PYTTN_TTNS_LIB_CORE_MATRIX_ELEMENT_CORE_HPP_
#define PYTTN_TTNS_LIB_CORE_MATRIX_ELEMENT_CORE_HPP_
...
#endif // PYTTN_TTNS_LIB_CORE_MATRIX_ELEMENT_CORE_HPP_//
