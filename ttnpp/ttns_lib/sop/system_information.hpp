...
#ifndef PYTTN_TTNS_LIB_SOP_SYSTEM_INFORMATION_HPP_
#define PYTTN_TTNS_LIB_SOP_SYSTEM_INFORMATION_HPP_
...
namespace ttns
{
    ...
    public:
        ...
        {
            for (size_t i = 0; i < m_tree_leaf_indices.size(); ++i)
            {
                m_tree_leaf_indices[i] = i;
            }
        }
...
#endif // PYTTN_TTNS_LIB_SOP_SYSTEM_INFORMATION_HPP_
