...
#ifndef PYTTN_TTNS_LIB_SOP_MODELS_SPIN_BOSON_HPP_
#define PYTTN_TTNS_LIB_SOP_MODELS_SPIN_BOSON_HPP_
...
namespace ttns
{
    ...
    public:
        ...
        spin_boson_star(real_type eps, real_type delta, const std::vector<real_type> &_w, const std::vector<value_type> &_g) : base_type(0, eps, delta, _w.size()), m_w(_w), m_g(_g){
                                                                                                                                                                                 ASSERT(_w.size() == _g.size(), "Invalid boson parameters.")} spin_boson_star(size_t spin_index, real_type eps, real_type delta, const std::vector<real_type> &_w, const std::vector<value_type> &_g) : base_type(spin_index, eps, delta, _w.size()), m_w(_w), m_g(_g)
        {
...
#endif // PYTTN_TTNS_LIB_SOP_MODELS_SPIN_BOSON_HPP_
