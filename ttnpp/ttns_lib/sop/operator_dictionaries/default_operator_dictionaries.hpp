...
#ifndef PYTTN_TTNS_LIB_SOP_OPERATOR_DICTIONARIES_DEFAULT_OPERATOR_DICTIONARIES_HPP_
#define PYTTN_TTNS_LIB_SOP_OPERATOR_DICTIONARIES_DEFAULT_OPERATOR_DICTIONARIES_HPP_
        ...
        typename default_fermion_operator_dictionary<T>::dict_type default_fermion_operator_dictionary<T>::s_dict =
            {
                ...
                {std::string("cdag"), std::make_shared<creation<T>>()},
                {std::string("cd"), std::make_shared<creation<T>>()},
                {std::string("adag"), std::make_shared<creation<T>>()},
                {std::string("ad"), std::make_shared<creation<T>>()},
                {std::string("fdag"), std::make_shared<creation<T>>()},
                {std::string("fd"), std::make_shared<creation<T>>()},
                ...
                {std::string("cdagc"), std::make_shared<number<T>>()},
                {std::string("cdc"), std::make_shared<number<T>>()},
                {std::string("adaga"), std::make_shared<number<T>>()},
                {std::string("ada"), std::make_shared<number<T>>()},
                {std::string("fdagf"), std::make_shared<number<T>>()},
                {std::string("fdf"), std::make_shared<number<T>>()},
        ...
        typename default_boson_operator_dictionary<T>::dict_type default_boson_operator_dictionary<T>::s_dict =
            {
                ...
                {std::string("adag"), std::make_shared<creation<T>>()},
                {std::string("ad"), std::make_shared<creation<T>>()},
                {std::string("bdag"), std::make_shared<creation<T>>()},
                {std::string("bd"), std::make_shared<creation<T>>()},
                // bind the annihilation<T> operators
                {std::string("c"), std::make_shared<annihilation<T>>()},
                {std::string("a"), std::make_shared<annihilation<T>>()},
                ...
                {std::string("adaga"), std::make_shared<number<T>>()},
                {std::string("ada"), std::make_shared<number<T>>()},
                {std::string("bdagb"), std::make_shared<number<T>>()},
                {std::string("bdb"), std::make_shared<number<T>>()},
        ...
        typename default_spin_operator_dictionary<T>::dict_type default_spin_operator_dictionary<T>::s_dict =
            {
                ...
                {std::string("s+"), std::make_shared<S_p<T>>()},
                {std::string("sp"), std::make_shared<S_p<T>>()},
                // bind the spin lower operators
                {std::string("s-"), std::make_shared<S_m<T>>()},
                {std::string("sm"), std::make_shared<S_m<T>>()},
        ...
        typename default_pauli_operator_dictionary<T>::dict_type default_pauli_operator_dictionary<T>::s_dict =
            {
                ...
                {std::string("s+"), std::make_shared<sigma_p<T>>()},
                {std::string("sp"), std::make_shared<sigma_p<T>>()},
...
#endif // PYTTN_TTNS_LIB_SOP_OPERATOR_DICTIONARIES_DEFAULT_OPERATOR_DICTIONARIES_HPP_
