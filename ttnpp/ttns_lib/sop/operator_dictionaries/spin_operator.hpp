...
#ifndef PYTTN_TTNS_LIB_SOP_OPERATOR_DICTIONARIES_SPIN_OPERATOR_HPP_
#define PYTTN_TTNS_LIB_SOP_OPERATOR_DICTIONARIES_SPIN_OPERATOR_HPP_
...
namespace ttns
{
    namespace spin
    {
        ...
        class S_y<std::complex<RT>, true> : public single_site_operator<std::complex<RT>>
        {
        public:
...
#endif // PYTTN_TTNS_LIB_SOP_OPERATOR_DICTIONARIES_SPIN_OPERATOR_HPP_
