...
#ifndef PYTTN_TTNS_LIB_SWEEPING_ALGORITHM_UPDATE_SWEEPING_ALGORITHM_HPP_
#define PYTTN_TTNS_LIB_SWEEPING_ALGORITHM_UPDATE_SWEEPING_ALGORITHM_HPP_
    ...
    public:
        ...
        bool operator()(ttn_type &A, env_type &op, bool update_environment = false)
        {
            try
            {
                ...
                return update(A, op, [this](hnode &_A, const environment_type &_env, env_node_type &_h, env_type &_op)
                              { CALL_AND_RETHROW(static_cast<update_type *>(this)->update_site_tensor(_A, _env, _h, _op)); }, [this](bond_matrix_type &_r, const environment_type &_env, env_node_type &_h, env_type &_op)
                              { CALL_AND_RETHROW(static_cast<update_type *>(this)->update_bond_tensor(_r, _env, _h, _op)); }, [this](hnode &_a1, hnode &_a2, bond_matrix_type &_r, population_matrix_type &_s, env_node_type &_h, env_type &_op, environment_type &_env, linalg::random_engine<backend> &_rng)
                              { CALL_AND_RETHROW(return static_cast<subspace_type *>(this)->subspace_expansion_down(_a1, _a2, _r, _s, _h, _op, _env, _rng)); }, [this](hnode &_a1, hnode &_a2, bond_matrix_type &_r, population_matrix_type &_s, env_node_type &_h, env_type &_op, environment_type &_env, linalg::random_engine<backend> &_rng)
                              { CALL_AND_RETHROW(return static_cast<subspace_type *>(this)->subspace_expansion_up(_a1, _a2, _r, _s, _h, _op, _env, _rng)); }, [this](env_type &_op, hnode &_a1, env_node_type &_h)
                              { CALL_AND_RETHROW(this->m_env.update_env_down(_op, _a1, _h)); }, [this](env_type &_op, hnode &_a1, env_node_type &_h)
        ...
        bool prepare_environment(ttn_type &A, env_type &op, bool attempt_expansion = false)
        {
            ...
            {
                const auto &a = std::get<0>(z);
                auto &hspf = std::get<1>(z);
            ...
            while (attempt_expansion)
            {
                ...
                CALL_AND_HANDLE(
                    subspace_expanded_f = forward_loop_step(A, op, [](hnode &, const environment_type &, env_node_type &, env_type &) {}, [](bond_matrix_type &, const environment_type &, env_node_type &, env_type &) {}, [this](hnode &_a1, hnode &_a2, bond_matrix_type &_r, population_matrix_type &_s, env_node_type &_h, env_type &_op, environment_type &_env, linalg::random_engine<backend> &_rng)
                                                            { CALL_AND_RETHROW(return static_cast<subspace_type *>(this)->subspace_expansion_down(_a1, _a2, _r, _s, _h, _op, _env, _rng)); }, [this](env_type &_op, hnode &_a1, env_node_type &_h)
                                                            { CALL_AND_RETHROW(this->m_env.update_env_down(_op, _a1, _h)); }, [this](env_type &_op, hnode &_a1, env_node_type &_h)
                                                            { CALL_AND_RETHROW(this->m_env.update_env_up(_op, _a1, _h)); }),
                ...
                CALL_AND_HANDLE(
                    subspace_expanded_b = backward_loop_step(A, op, [](hnode &, const environment_type &, env_node_type &, env_type &) {}, [](bond_matrix_type &, const environment_type &, env_node_type &, env_type &) {}, [this](hnode &_a1, hnode &_a2, bond_matrix_type &_r, population_matrix_type &_s, env_node_type &_h, env_type &_op, environment_type &_env, linalg::random_engine<backend> &_rng)
                                                             { CALL_AND_RETHROW(return static_cast<subspace_type *>(this)->subspace_expansion_up(_a1, _a2, _r, _s, _h, _op, _env, _rng)); }, [this](env_type &_op, hnode &_a1, env_node_type &_h)
                                                             { CALL_AND_RETHROW(this->m_env.update_env_down(_op, _a1, _h)); }, [this](env_type &_op, hnode &_a1, env_node_type &_h)
                                                             { CALL_AND_RETHROW(this->m_env.update_env_up(_op, _a1, _h)); }),
                    "Failed to perform subspace expansion step.");

                if (subspace_expanded_f || subspace_expanded_b)
                {
                    subspace_expanded = true;
                }
                if (!subspace_expanded_f && !subspace_expanded_b)
                {
                    attempt_expansion = false;
                }
            }
            m_env_set = true;
...
#endif // PYTTN_TTNS_LIB_SWEEPING_ALGORITHM_UPDATE_SWEEPING_ALGORITHM_HPP_//
