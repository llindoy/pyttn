...
#ifndef PYTTN_TTNS_LIB_SWEEPING_ALGORITHM_UPDATE_ASSIGNMENT_ENGINE_HPP_
#define PYTTN_TTNS_LIB_SWEEPING_ALGORITHM_UPDATE_ASSIGNMENT_ENGINE_HPP_
...
public:
  ...
  void initialise(const ttn_type &A, const parameter_list &o) {
    CALL_AND_RETHROW(initialise(A));
  }
  void initialise(const ttn_type &A, parameter_list &&o) {
    CALL_AND_RETHROW(initialise(A));
  }
  ...
  size_type update_site_tensor(hnode &A, const environment_type &env,
                               env_node_type &h, env_type &op) {}

  void update_bond_tensor(bond_matrix_type & /* r */,
...
#endif // PYTTN_TTNS_LIB_SWEEPING_ALGORITHM_UPDATE_ASSIGNMENT_ENGINE_HPP_
