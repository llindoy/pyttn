...
#ifndef PYTTN_TTNS_LIB_TTN_TTN_NODES_NODE_TRAITS_MS_TTN_NODE_TRAITS_HPP_
#define PYTTN_TTNS_LIB_TTN_TTN_NODES_NODE_TRAITS_MS_TTN_NODE_TRAITS_HPP_
...
namespace ttns
{
    ...
    namespace node_data_traits
    {
        ...
        struct resize_traits<multiset_node_data<T, backend1>, multiset_node_data<U, backend2>>
        {
            ...
            using hdata = multiset_node_data<V, backend>;
        ...
        struct resize_traits<multiset_node_data<T, backend1>, ttn_node_data<U, backend2>>
        {
            ...
            using hdata = multiset_node_data<V, backend>;
            template <typename V, typename backend>
            using hdata2 = ttn_node_data<V, backend>;
        ...
        struct size_comparison_traits<multiset_node_data<T, backend1>, multiset_node_data<U, backend2>>
        {
            ...
            inline bool operator()(hdata<T, backend1> &o, const hdata<U, backend2> &i)
            {
                if (o.size() == i.size())
                {
                    ...
                    {
                        if (o[ind].nmodes() != i[ind].nmodes())
                        {
                            return false;
                        }
                        else if (!((o[ind].shape() == i[ind].shape()) && (o[ind].dims() == i[ind].dims())))
                        {
                            return false;
                        }
                    }
...
#endif // PYTTN_TTNS_LIB_TTN_TTN_NODES_NODE_TRAITS_MS_TTN_NODE_TRAITS_HPP_//
