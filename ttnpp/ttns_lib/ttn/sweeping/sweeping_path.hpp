...
#ifndef PYTTN_TTNS_LIB_TTN_SWEEPING_SWEEPING_PATH_HPP_
#define PYTTN_TTNS_LIB_TTN_SWEEPING_SWEEPING_PATH_HPP_
    ...
    namespace sweeping
    {
        ...
        public:
            ...
            void initialise(const std::vector<size_type> &path)
            {
                ...
                m_times_visited.resize(nterms + 1);
                std::fill(m_times_visited.begin(), m_times_visited.end(), 0);
                m_visits.resize(nterms + 1);
                std::fill(m_times_visited.begin(), m_times_visited.end(), 0);
...
#endif // PYTTN_TTNS_LIB_TTN_SWEEPING_SWEEPING_PATH_HPP_
