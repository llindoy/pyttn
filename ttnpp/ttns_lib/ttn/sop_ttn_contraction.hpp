...
#ifndef PYTTN_TTNS_LIB_TTN_SOP_TTN_CONTRACTION_HPP_
#define PYTTN_TTNS_LIB_TTN_SOP_TTN_CONTRACTION_HPP_
                ...
                if (!is_leaf)
                {
                    try
                    {
                        ...
                        for (size_type cind = 0; cind < A[i].size(); ++cind)
                        {
                            ...
                            if (dimen[cind] > maxdimen[cind])
                            {
                                maxdimen[cind] = dimen[cind];
                            }
                        }
...
#endif // PYTTN_TTNS_LIB_TTN_SOP_TTN_CONTRACTION_HPP_//
