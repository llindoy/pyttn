...
#ifndef PYTTN_TTNS_LIB_TTN_MULTISET_TTN_SLICE_HPP_
#define PYTTN_TTNS_LIB_TTN_MULTISET_TTN_SLICE_HPP_
...
namespace ttns
{
    ...
    public:
        ...
        const_node_data operator()(size_type i1) const
        {
            ASSERT(i1 == 0, "Invalid set index");
            return base_type::get_node_data_slice(m_slice_index);
        }
        node_data operator()(size_type i1)
        {
            ASSERT(i1 == 0, "Invalid set index");
            return base_type::get_node_data_slice(m_slice_index);
        }
...
#endif // PYTTN_TTNS_LIB_TTN_MULTISET_TTN_SLICE_HPP_
